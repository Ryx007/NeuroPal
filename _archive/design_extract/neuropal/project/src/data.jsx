// ─────────────────────────────────────────────────────────────────────
// NeuroPal content — two papers, chat seeds, library, user, state
// Kept loose/readable so you can scan the prose like a real paper.
// ─────────────────────────────────────────────────────────────────────
...
const NEURO_PAPER = {
  ...
  sections: [
    ...
    {
      id: "s2",
      heading: "Prefrontal Mediation and Filtering",
      paragraphs: [
    ...
    {
      id: "s3",
      heading: "Auditory Synchronisation and Retention",
      paragraphs: [
    ...
    {
      id: "s4",
      heading: "Designing for Re-Entry",
      paragraphs: [
...
const PHYSICS_PAPER = {
  ...
  sections: [
    ...
    {
      id: "s3",
      heading: "Experimental Signatures",
      paragraphs: [
...
const PAPERS = [NEURO_PAPER, PHYSICS_PAPER];

// Per-paper inline Q&A annotations (appear as margin notes when chat is open)
const NEURO_NOTES = [
  {
    anchorPara: "p3",
    q: "What does 'the digital cocoon' refer to?",
    a: "A minimal-stimuli reading environment — no sidebars, ads or formatting noise — that lets the prefrontal filter stop fighting the UI and start processing the text. The term originates with the Broadbent lab (2019).",
    cite: "§2 ¶1 · Broadbent et al., 2019",
  },
  {
    anchorPara: "p5",
    q: "How strong is the retention effect?",
    a: "In the 312-participant study, TTS + word-level highlighting produced +34% recall at 48h vs silent reading. Dyslexic participants saw +48%.",
    cite: "§3 ¶2 · Okafor 2024, Table 1",
  },
  {
    anchorPara: "p7",
    q: "Why is attention framed as non-stationary?",
    a: "Because neurodivergent focus tends to follow interest gradients rather than the clock. Designing for re-entry (persistent markers, predictable chrome) is more humane than penalising drift.",
    cite: "§4 ¶1",
  },
];
...
const PHYSICS_NOTES = [
  {
    anchorPara: "p1",
    q: "What's a compact U(1) gauge field in plain terms?",
    a: "An emergent photon-like excitation: a collective mode of the spins that behaves mathematically like electromagnetism, even though no real photons are involved. The signature is a linear, gapless dispersion.",
    cite: "§1 Abstract",
  },
  {
    anchorPara: "p4",
    q: "Why does intensity scaling matter?",
    a: "I(ω,T) = T^α · f(ω/T) is a conformal-field-theory fingerprint. An exponent α ≈ 2 is consistent with an emergent photon CFT, ruling out ordinary magnon descriptions.",
    cite: "§3 ¶1",
  },
];

// Seed chat per paper
const SEED_CHAT_NEURO = [
  { role: "user", text: "Summarise the retention findings for me in three bullets." },
  { role: "assistant", text: "Three bullets:\n• TTS + word-level highlighting → +34% recall at 48h (n=312).\n• Dyslexic participants benefited most (Δ = +48%).\n• Effect is strongest when auditory pacing matches the reader's natural WPM, not a fixed 200.",
    cites: [{ page: "§3", para: "p6" }] },
];

const SEED_CHAT_PHYSICS = [
  { role: "user", text: "Does the specific heat agree with the photon picture?" },
  { role: "assistant", text: "Partially. The T² regime appears above 200 mK, consistent with a gapless linear mode, but below 100 mK there is an anomalous upturn the authors attribute to residual impurity moments. They flag this in §4 as the outstanding tension with the scattering data.",
    cites: [{ page: "§3", para: "p5" }] },
];
...
const LIBRARY_ITEMS = [
  {
    id: "neuro-1",
    title: "Neuroplasticity and the Architecture of Attention",
    authors: "Okafor, Lindqvist & Chen · 2024",
    kind: "Neuroscience",
    progress: 0.45,
    minutes: 12,
    color: "primary",
  },
  {
    id: "phys-1",
    title: "Emergent U(1) Gauge Fields in a Frustrated Kagome Antiferromagnet",
    authors: "Álvarez-Castillo, Nakamura & Whitfield · 2024",
    kind: "Physics · arXiv",
    progress: 0.12,
    minutes: 22,
    color: "tertiary",
  },
  {
    ...
    authors: "Bessel van der Kolk · 2014",
    kind: "Book",
    progress: 0.63,
    minutes: 540,
    color: "secondary",
  ...
  {
    id: "defaultmode",
    title: "Default Mode Network and Rumination in PTSD",
    authors: "Hassan & Pereira · 2023",
    kind: "Neuroscience",
    progress: 0.0,
    minutes: 18,
    color: "primary",
...
// Citation graph nodes (for the Reader's citation mode)
...
Object.assign(window, {
  PAPERS, NEURO_PAPER, PHYSICS_PAPER,
  NEURO_NOTES, PHYSICS_NOTES,
  SEED_CHAT_NEURO, SEED_CHAT_PHYSICS,
  LIBRARY_ITEMS, CITATION_GRAPH, USER,
});
