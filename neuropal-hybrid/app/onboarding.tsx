...
import {
  ...
  setEnergy as setEnergyAction,
  setPrimaryUse as setPrimaryUseAction,
  toggleCondition as toggleConditionAction,
...
export default function OnboardingScreen() {
  ...
  const toggleCondition = (id: string) =>
    dispatch(toggleConditionAction(id));
  const setEnergy = (v: "morning" | "night" | "variable") =>
    dispatch(setEnergyAction(v));
  const setPrimary = (v: "reading" | "regulation" | "both") =>
    dispatch(setPrimaryUseAction(v));
  const complete = () => dispatch(completeOnboarding());
  ...
  const setPageIndex = (n: number) => {
    ...
    ref.current?.scrollTo?.({
      x: n * Dimensions.get("window").width,
      animated: true,
    });
  };
    ...
    >
      ...
      <PagerLike
        ...
        pages={[
          ...
          />,
          <EnergyPage key="e" value={energyPattern} onPick={setEnergy} />,
          <UsePage key="u" value={primaryUse} onPick={setPrimary} />,
          <SummaryPage
            key="s"
