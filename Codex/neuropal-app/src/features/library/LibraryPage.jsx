...
import { selectLibraryFilter } from './selectors';
import { setFilter } from './store/librarySlice';
import { setActivePaper } from '../reader/store/readerSlice';
...
function DropZone() {
  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: 'flex', gap: 1, justifyContent: { xs: 'center', md: 'flex-end' }, flexWrap: 'wrap' }}>
...
export default function LibraryPage() {
  ...
  return (
    <Box className="app-page">
      <Box className="app-max gap-8">
        <DropZone />

        <Box sx={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: 1.5, borderBottom: '1px solid rgba(67,70,83,0.15)' }}>
          <Tabs
            value={filter}
          ...
          <TextField
            ...
            sx={{ width: { xs: '100%', md: 280 }, '& fieldset': { borderColor: 'rgba(67,70,83,0.15)' } }}
          />
        </Box>
