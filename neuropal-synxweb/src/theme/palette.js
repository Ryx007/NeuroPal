// Clinical Visionary palette — same constants as the other NeuroPal builds
// (DESIGN.md is the source of truth). Plain JS export so it can be read by
// `connect(mapStateToProps)`-wrapped components AND hooks alike.
...
const THEMES = { dark, sepia, light, contrast };

export function resolvePalette(theme, accent) {
    const base = THEMES[theme] || dark;
