// Seed content for the MVP — gets dispatched into configSlice on App boot
// (mirrors Synxweb's `app/preview` -> Redux populate pattern).
...
export const MockDocuments = [
    {
        ...
        sections: [
            ...
            },
            {
                ...
                paragraphs: [
                    'Research indicates that auditory synchronisation significantly enhances retention. As the words are highlighted in real time, the visual and auditory processing centers of the brain align, reducing the cognitive load required to decode phonemes.',
                    'In our cohort of 142 adult participants, the combined read-and-listen condition outperformed silent reading on 24-hour recall by 18.4 percentage points (p < 0.001).',
                ],
            },
        ],
    },
...
export const MockAnchors = [
    { id: 'a-1', title: 'Morning meds', subtitle: 'Blue, with water', time: { hour: 8, minute: 0 }, status: 'done', icon: 'medication' },
    { id: 'a-2', title: 'Focus block', subtitle: 'Neuroscience paper', time: { hour: 10, minute: 30 }, status: 'done', icon: 'psychology' },
    { id: 'a-3', title: 'Lunch', subtitle: 'Leave the desk', time: { hour: 13, minute: 0 }, status: 'current', icon: 'restaurant' },
    { id: 'a-4', title: 'Walk + sunlight', subtitle: '10 minutes outside', time: { hour: 16, minute: 0 }, status: 'pending', icon: 'directions-walk' },
    { id: 'a-5', title: 'Wind-down', subtitle: 'Phone on greyscale', time: { hour: 21, minute: 30 }, status: 'pending', icon: 'bedtime' },
];

export const MockSeedChat = [
    {
        id: 'c-1',
