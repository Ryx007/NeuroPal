...
/**
 * Emergency protocol — TIPP card deck.
 * Opens full-bleed (no tabs), destination for a Red state check-in or a
 * future smartwatch long-press trigger (Plan §Module 8).
 */
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: palette.surface }}>
      <View style={{ flex: 1, padding: 24 }}>
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          <Pressable onPress={() => router.replace("/")} accessibilityLabel="Close">
            <MaterialIcons name="close" size={26} color={palette.onSurface} />
          </Pressable>
          <View style={{ flex: 1 }} />
          <Text
            style={{
        ...
        >
          This is the body's alarm system — not a decision to make. Follow the
          steps, one at a time.
        </Text>
