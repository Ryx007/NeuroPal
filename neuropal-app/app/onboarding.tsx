...
import { useOnboarding } from "@/state/app";
...
export default function OnboardingScreen() {
  ...
  const conditions = useOnboarding((s) => s.conditions);
  const toggleCondition = useOnboarding((s) => s.toggleCondition);
  const energyPattern = useOnboarding((s) => s.energyPattern);
  const setEnergy = useOnboarding((s) => s.setEnergy);
  const primaryUse = useOnboarding((s) => s.primaryUse);
  const setPrimary = useOnboarding((s) => s.setPrimaryUse);
